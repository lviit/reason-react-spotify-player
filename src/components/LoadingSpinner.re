module Styles = {
  ...
  let spinner =
    style([
      ...
      borderTop(em(2.5), `solid, rgba(0, 0, 0, 0.2)),
      borderRight(em(2.5), `solid, rgba(0, 0, 0, 0.2)),
      borderBottom(em(2.5), `solid, rgba(0, 0, 0, 0.2)),
      borderLeft(em(2.5), `solid, rgba(0, 0, 0, 0.6)),
